package com.completeableFuture.multithread.service;

import com.completeableFuture.multithread.entity.User;
import com.completeableFuture.multithread.repository.UserRepository;
...
public class UserService {
    ...
    public CompletableFuture<List<User>> findAllUsers(){
        logger.info("list of users by", " "+Thread.currentThread().getName());
